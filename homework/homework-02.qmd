...
mAW <- brm(formula = weight ~ age, data = d, family = gaussian(),
...
mAWS <- brm(formula = weight ~ age + sex, data = d2, family = gaussian(),
           prior = c(set_prior("normal(5, 1)", class = "Intercept"),
